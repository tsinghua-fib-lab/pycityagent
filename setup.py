...
BIN_SOURCES = {
    "pycityagent-sim": {
        "linux_x86_64": "https://git.fiblab.net/api/v4/projects/195/packages/generic/socialcity-sim/v1.0.13/socialcity-sim-noproj-linux-amd64",
        "darwin_arm64": "https://git.fiblab.net/api/v4/projects/195/packages/generic/socialcity-sim/v1.0.13/socialcity-sim-noproj-darwin-arm64",
    },
    "pycityagent-ui": {
